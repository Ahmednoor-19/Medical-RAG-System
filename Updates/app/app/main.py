...
import app.retriever_service as retriever_service
import app.qa_service as qa_service
import app.exam_mcq_service as exam_mcq_service
...
app.include_router(exam_mcq_service.router)
